...
void system_init(void)
{
	 ...
	 //对PWM初始化赋值
	 TIM3->CCR2 = 3600;	//电机设置这个寄存器 TIM3->CCR2 = 3600;	//电机设置这个寄存器
     TIM3->CCR1 = 3600;	//电机设置这个寄存器 TIM3->CCR1 = 3600;	//电机设置这个寄存器 
     TIM3->CCR3 = 3600;	//电机设置这个寄存器 TIM3->CCR3 = 3600;	//电机设置这个寄存器
	 TIM3->CCR4 = 3600;	//电机设置这个寄存器 TIM3->CCR4 = 3600;	//电机设置这个寄存器	 	
}
